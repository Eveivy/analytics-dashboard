...
const NavBar = () => {
    return (
        <nav className='fixed top-0 left-[77px] right-0 bg-[#FAFAFA]'>
            <div className="border-b border-r-[#EBECF2] px-5 py-[18px] grid grid-cols-3 gap-4">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="rounded-full border border-[#DADDDD] flex items-center justify-center py-[6px] px-2 w-auto cursor-pointer">
                        ...
                        <div className={`${inter.variable} flex flex-col justify-center items-center mx-1`}>
                            <p className="text-[#26282C] text-right text-base font-normal whitespace-nowrap">Justin Bergson</p>
                            <span className="text-[#787486] text-right text-sm font-normal whitespace-nowrap">Justin@gmail.com</span>
                        </div>
                        <span><ArrowDown2 size="20" color="#0D062D"/></span>
                    </div>
                </div>
            </div>
        </nav>
